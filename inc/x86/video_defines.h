/**
 * @file inc/x86/video_defines.h
 * @brief Important values for console output.
 *
...
#ifndef __INC_VIDEO_DEFINES_H__
#define __INC_VIDEO_DEFINES_H__
