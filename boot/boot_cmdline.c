/**
 * @file boot/boot_cmdline.c
 * @brief Boot command-line parser
 *
...
/**
 * @brief Parse command-line arguments from boot
 *
 ...
 */
void boot_cmdline(mbinfo_t *mbi, int *argc, char ***argv, char ***envp) {
